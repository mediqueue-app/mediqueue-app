...
export function CalendarView({
  ...
  return (
    <div className="animate-fade-in-up stagger-1 flex flex-col gap-5">
      {Toast}
      {/* Üst toolbar */}
      <div className="flex flex-col gap-4 rounded-[1.5rem] border border-white/80 bg-white/95 p-4 shadow-sm backdrop-blur-sm lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-xs font-semibold text-white shadow-sm shadow-primary/25 hover:bg-primary-hover"
          >
