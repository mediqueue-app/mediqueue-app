  ...
  return (
    <>
      <button
        ...
        className="mt-4 inline-flex min-h-12 items-center rounded-xl border border-red-200 bg-white px-4 py-2 text-sm font-semibold text-red-600 hover:bg-red-50"
      >
