...
const CONFIG: Record<DataSource, SourceConfig> = {
  api: {
    label: "Canlı API",
    tip: "Bu veriler canlı API sunucusundan alınmıştır.",
  ...
  hybrid: {
    ...
    badge: "bg-[#eaf0fc] text-[#3a6ad6] ring-[#3a6ad6]/20",
    dot: <span className="h-2 w-2 rounded-full bg-[#3a6ad6]" />,
  },
};

/**
 * Verinin kaynağını (canlı API / demo mock / hibrit) şeffafça belirten,
 * tasarım diliyle uyumlu küçük bir rozet. Salt görsel bir göstergedir;
