...
export function ClinicsHero() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-border">
      ...
      <Container className="relative grid items-center gap-12 pt-8 pb-16 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:gap-16 lg:pt-12 lg:pb-20">
        <FadeIn>
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <Button href="/how-it-works" variant="ink" size="lg">
              {c.secondaryCta}
            </Button>
          </div>
        </FadeIn>
